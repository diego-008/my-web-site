    ...
    return(
        <div className="container mb-5" style={{marginTop: '110px'}}>
            ...
            <div className="row align-items-center mt-5">
                ...
                <div className="col-lg-4 d-flex justify-content-center mt-lg-0 mt-5">
                    <Card title='PENDIENTE' imagen={Contacts} link="https://github.com/diego-008/FlaskContactsApp" text='Aplicación para guardar contactos por utilizando flask y mysql' />
                </div>
            </div>
        </div>
    )
